...
def enemy_lizardman(player_FP, player_HP):
    if enemy == 'lizardman':
        enemy_HP = 75
                        ...
                        if AI_action == 'block':
                            ...
                            if player_action == 'magic':
                                ...
                                print(
                                    ...
                                    f'lizardman has {enemy_HP - player_damage} left')
                        ...
                        if player_stats.PPA_attack >= 2:
                            ...
                            if AI_action == 'block':
                                if player_action == 'attack':
                                    damagelist_lizardman = range(10, 35)
                                    damage = random.choice(damagelist_lizardman)
                                    print(f'lizardman block your attack and countered.\n'
                                          f'lizardman did {damage} points of damage.\n'
                                          f' you have {player_stats.player_HP - damage} left')
                                    player_stats.player_HP -= damage
                                if player_action == 'magic':
                                    ...
                                    damagelist_player = range(5, 40)
                                    player_damage = random.choice(damagelist_player) * multiplier
                                    print(f'the lizardman tried to block your attack, but the magic was to strong and hitted the enemy\n'
                                          f'you did {player_damage} points of damage.\n'
                                          f'lizardman has {enemy_HP - player_damage} left')
                                    enemy_HP -= player_damage
                                if player_action == 'dodge':
                        ...
                        if player_stats.PPA_magic >= 2:
                            ...
                            if AI_action == 'dodge':
                                ...
                                if player_action == 'dodge':
                                    print('both you and the enemy dodged')
                                if player_action == 'block':
                                    print('you blocked, but the lizardman dodged and so 0 points of damage to both.')
                                if player_action == 'magic':
                                    damagelist_lizardman = range(10, 35)
                                    damage = random.choice(damagelist_lizardman)
                                    print(f'lizardman dodged your spell and countered.\n'
